...
export default function GenerateLetterModal({
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div
        className="glass-card shadow-soft-3 relative z-10 w-full max-w-3xl rounded-3xl p-8"
          ...
          <div className="glass border-peach-200/50 dark:border-coral-500/20 rounded-2xl border p-6">
            <div className="max-h-96 space-y-4 overflow-y-auto">
              ...
              <p className="leading-relaxed text-dark-5 dark:text-gray-400">
                ...
                property located at {mockLetterData.address}. As you may recall,
                I was a tenant at this property and provided a security deposit
                of {mockLetterData.amount} at the beginning of my tenancy.
              </p>
              <p className="leading-relaxed text-dark-5 dark:text-gray-400">
                Under Massachusetts General Laws Chapter 186, Section 15B,
                landlords are required to return a tenant's security deposit
                within 30 days of the termination of the tenancy, along with an
                itemized statement of any deductions. As of today, more than 30
                days have passed since the end of my tenancy, and I have not
                received my security deposit or any itemized statement of
                deductions.
              </p>
              <p className="leading-relaxed text-dark-5 dark:text-gray-400">
